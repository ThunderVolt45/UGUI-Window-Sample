...
namespace UGUIWindow
{
    ...
    public class UGUIWindowEdge : MonoBehaviour, IPointerDownHandler, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        public UGUIEdgePosition edgePosition = UGUIEdgePosition.NorthEast;
